...
Do not perform broad fuzzing, speculative exploitation, destructive requests, long blind enumeration, or high-volume testing during bootstrap. Bootstrap output should contain only confirmed facts that help Reason build precise repro, root-cause, or impact-analysis intents.
