...
4. Save commands, scripts, flags, and decisive outputs under `/mnt/project/`.
5. Before marking complete, save `/mnt/project/reports/writeup.md` and a reusable `/mnt/project/exploit/solve.*` script when scriptable.
